...
describe("smoke: the orrery command on the diagram of Orrery", () => {
  ...
  it("renders the interactive file with the model and the engine inside, and a static one without", () => {
  ...
  it("exports every picture the model lists, byte for byte the same twice", () => {
  ...
  it("embeds a page, and lists the packs the diagram uses", () => {
