...
your states, click a closed group to drill in and its frame's own edge or corner mark to close it again, Escape to step back out, digits to switch views, `s` to start a
